...
public class AudioRecorder {
    ...
    public AudioRecorder(Listener listener) {
        Log.i(TAG, "entering AudioRecorder Class AudioRecorder");
        ...
        Thread mRecordingThread = new Thread(new Runnable() {
            public void run() {
                Log.i(TAG, "entering mRecordingThread Class AudioRecorder");
                ...
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.JELLY_BEAN) {
                    ...
                    Log.i(TAG, "NoiseSuppressor.isAvailable() " + NoiseSuppressor.isAvailable());
                }
    ...
    synchronized public void start() {
        Log.i(TAG, "entering start Class AudioRecorder");
        mIsRecording = true;
        notify();
    }
    ...
    synchronized public void release() {
        Log.i(TAG, "entering release Class AudioRecorder");
        mIsRecording = false;
        mReleased = true;
        notify();
        mRecorder.release();
