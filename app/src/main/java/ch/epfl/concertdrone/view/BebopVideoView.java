package ch.epfl.concertdrone.view;
...
public class BebopVideoView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void displayFrame(ARFrame frame) {
        //Log.i(TAG, "entering displayFrame Class BebopVideoView");
        mReadyLock.lock();
    ...
    public void configureDecoder(ARControllerCodec codec) {
        Log.i(TAG, "entering configureDecoder Class BebopVideoView");
        mReadyLock.lock();
    ...
    private void configureMediaCodec() {
        Log.i(TAG, "entering configureMediaCodec Class BebopVideoView");
        mMediaCodec.stop();
    ...
    private void initMediaCodec(String type) {
        Log.i(TAG, "entering initMediaCodec Class BebopVideoView");
        try {
    ...
    private void releaseMediaCodec() {
        Log.i(TAG, "entering releaseMediaCodec Class BebopVideoView");
        if (mMediaCodec != null) {
            if (mIsCodecConfigured) {
                mMediaCodec.stop();
                mMediaCodec.release();
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        Log.i(TAG, "entering surfaceCreated Class BebopVideoView");
        mReadyLock.lock();
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        Log.i(TAG, "entering surfaceDestroyed Class BebopVideoView");
        deInit();
    }
