package ch.epfl.concertdrone.discovery;
...
public class DroneDiscoverer {
    ...
    private final ARDiscoveryServicesDevicesListUpdatedReceiverDelegate mDiscoveryListener =
            new ARDiscoveryServicesDevicesListUpdatedReceiverDelegate() {
                ...
                public void onServicesDevicesListUpdated() {
                    Log.i(TAG, "entering ARDiscoveryServicesDevicesListUpdatedReceiverDelegate Class DroneDiscoverer");
    ...
    public DroneDiscoverer(Context ctx) {
        Log.i(TAG, "entering Context Class DroneDiscoverer");
        mCtx = ctx;
    ...
    public void addListener(Listener listener) {
        Log.i(TAG, "entering addListener Class DroneDiscoverer");
     ...
     */
    public void setup() {
        Log.i(TAG, "entering setup Class DroneDiscoverer");
        // registerReceivers
     ...
     */
    public void cleanup() {
        Log.i(TAG, "entering cleanup Class DroneDiscoverer");
        stopDiscovering();
    ...
    public void startDiscovering() {
        Log.i(TAG, "entering startDiscovering Class DroneDiscoverer");
        if (mArdiscoveryService != null) {
    ...
    public void stopDiscovering() {
        Log.i(TAG, "entering stopDiscovering Class DroneDiscoverer");
        if (mArdiscoveryService != null) {
    ...
    private void notifyServiceDiscovered(List<ARDiscoveryDeviceService> dronesList) {
        Log.i(TAG, "entering notifyServiceDiscovered Class DroneDiscoverer");
